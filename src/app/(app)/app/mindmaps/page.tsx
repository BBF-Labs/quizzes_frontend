...
import { ArrowUpRight, Network, Search, Trash2, X, Plus } from "lucide-react";
  ...
  return (
    <div className="min-h-full px-4 py-8">
          ...
          >
            ...
            <p className="text-[11px] font-mono uppercase tracking-widest text-muted-foreground/50">
              {search || courseFilter
                ...
                : "No mind maps yet. Generate one to visualize your materials."}
            </p>
          </motion.div>
        )}
              ...
              {filtered.map((map) => (
                ...
                >
                  ...
                  >
                    ...
                    <p className="mt-4 text-[9px] font-mono text-muted-foreground/40">
      ...
      <GenerationDialog
        ...
        description="Select a material to synthesize into a deep hierarchical mind map."
        type="mindmap"
