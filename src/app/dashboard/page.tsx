      ...
      <main className="flex-1 flex items-center justify-center p-4 relative py-24">
        ...
        <div className="max-w-md w-full mx-auto">
          <motion.div
            ...
            className="bg-card/40 border border-border/50 p-8 md:p-12 text-center relative overflow-hidden rounded-lg"
          >
            ...
            <div className="flex justify-center mb-8">
              <div className="w-16 h-16 bg-primary/20 flex items-center justify-center border border-primary/50 rounded-lg">
            ...
            <Link
              href="/"
              className="inline-flex items-center space-x-3 bg-primary px-8 py-4 text-primary-foreground font-mono text-xs font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-primary hover:ring-1 hover:ring-inset hover:ring-primary transition-all duration-300 group rounded-lg"
            >
