          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            {!disabled && (
              <button
                ...
                className="ml-2 text-muted-foreground/40 hover:text-destructive transition-colors rounded-lg"
                title="Remove Node"
              >
                <X className="size-4" />
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                disabled={disabled}
                className="rounded-lg font-mono text-xs h-9 bg-background/50 focus:bg-background transition-colors"
                  ...
                  <React.Fragment key={`${sIdx}-${seg}`}>
                    {isEditingPath === sIdx ? (
                      <Input
                        ...
                        disabled={disabled}
                        className="h-7 py-0 px-2 min-w-20 w-auto inline-block rounded-lg font-mono text-[11px] bg-background border-primary"
                      />
                    ) : (
                      <div className="relative group/seg inline-block">
                        <button
                          ...
                          className={cn(
                            "px-2 py-1 border transition-all truncate max-w-50 flex items-center gap-1.5 pr-6 rounded-lg",
                            seg.startsWith(":")
                        ...
                        >
                          {seg.startsWith(":") && (
                            <span className="size-1 bg-primary rounded-lg animate-pulse" />
                          )}
                          {seg}
                        </button>
                        {!disabled && (
                          <button
                            ...
                            className="absolute right-1 top-1/2 -translate-y-1/2 size-4 flex items-center justify-center text-muted-foreground/40 hover:text-destructive transition-colors rounded-lg"
                          >
      ...
      <div className="flex items-center justify-between">
        ...
        {!disabled && (
          <Button
            ...
            variant="outline"
            size="xs"
            className="rounded-lg font-mono text-[10px] tracking-widest uppercase border-primary/40 text-primary bg-primary/5 hover:bg-primary hover:text-primary-foreground"
          >
