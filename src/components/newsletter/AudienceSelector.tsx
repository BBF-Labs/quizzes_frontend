              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <Input
                    ...
                    className="rounded-lg h-9 w-20 font-mono text-xs"
                    disabled={disabled}
                  />
                    ...
                    <div key={email}>
                      {editingEmail === email ? (
                        <Input
                          ...
                          className="h-7 py-0 px-2 min-w-40 w-auto inline-block rounded-lg font-mono text-[10px] bg-background border-primary"
                        />
                      ) : (
                        <div
                          className={cn(
                ...
                {!disabled && (
                  <div className="space-y-2">
                    <Input
                      ...
                      className="rounded-lg h-9 font-mono text-[10px] bg-background/50 focus:bg-background transition-colors"
                    />
