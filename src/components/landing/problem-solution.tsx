        ...
        >
          {pillars.map((p, i) => (
            <motion.div key={i} variants={itemVariants}>
              <div
                className={`h-full border bg-card rounded-lg p-6 hover:border-primary transition-colors flex flex-col group relative overflow-hidden ${p.highlight ? "border-primary/50" : "border-border/50"}`}
              >
                <div
                ...
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`w-10 h-10 border flex items-center justify-center rounded-lg ${p.highlight ? "border-primary/50 bg-primary/10" : "border-border/50 bg-background"}`}
                  >
                    <p.Icon
