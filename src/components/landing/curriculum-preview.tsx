                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                          <span
                            className={`font-mono text-sm ${course.status === "pending" ? "text-muted-foreground" : "font-semibold text-foreground"}`}
                          >
                            {course.code}
                          </span>
                          <span
                            className={`text-[13px] sm:text-sm ${course.status === "pending" ? "text-muted-foreground" : course.status === "in-progress" ? "text-primary font-medium" : "text-foreground"}`}
                          >
                            {course.name}{" "}
                            {course.status === "in-progress" && (
                              <span className="text-[10px] ml-1 opacity-80 uppercase tracking-widest font-mono">
                                ← in progress
                              </span>
                            )}
                          </span>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                          ...
                          <span
                            className={`text-[13px] sm:text-sm ${course.status === "pending" ? "text-muted-foreground" : "text-foreground"}`}
                          >
                            {course.name}
                          </span>
                        </div>
