          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm font-mono uppercase tracking-widest text-[10px] md:text-xs">
                Z analyzes your performance to predict what you need to study
                next.
              </p>
            </div>
                  ...
                  <Card className="h-full flex flex-col border-border bg-card/80 backdrop-blur-sm overflow-hidden hover:border-primary/50 transition-colors rounded-(--radius)">
                    ...
                    <CardHeader className="pb-4">
                      ...
                      <h3 className="text-xl font-bold text-foreground line-clamp-2">
                        Big-O Notation Explained — MIT OpenCourseWare
                      </h3>
                    </CardHeader>
                    <CardContent className="flex flex-col flex-1 pb-6">
                ...
                >
                  <Card className="h-full flex flex-col border-border bg-card/80 backdrop-blur-sm overflow-hidden hover:border-primary/50 transition-colors rounded-(--radius)">
                    ...
                    <CardHeader className="pb-4">
                      ...
                      <h3 className="text-sm font-mono font-bold text-foreground tracking-tight uppercase leading-tight mb-1">
                        Kwame A.
                      </h3>
                      <p className="text-xs text-muted-foreground mt-1">
                        Dept of CS · 91% compatibility
                      </p>
                    </CardHeader>
                    <CardContent className="flex flex-col flex-1 pb-6">
                      <p className="text-[15px] text-muted-foreground mb-6 flex-1 font-light">
