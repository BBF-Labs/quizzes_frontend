  ...
  return (
    <section className="relative py-24 md:py-32 bg-background border-b border-border/50 flex flex-col items-center justify-center min-h-[60vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-150 h-75 rounded-full bg-primary/5 blur-[100px]" />
      </div>
      <div className="container mx-auto px-4 max-w-6xl text-center relative z-10">
        ...
        >
          ...
          <p className="text-[15px] text-muted-foreground mb-10 max-w-2xl mx-auto font-light leading-relaxed">
            Join the waitlist for private access. Qz is currently in private
            beta — be first to access AI-powered study tools built around your
            actual university curriculum.
          </p>

          <Button
            onClick={scrollToForm}
            className="h-14 px-10 rounded-lg font-mono text-sm font-bold tracking-widest uppercase bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-[0_0_30px_rgba(0,110,255,0.15)] hover:shadow-[0_0_40px_rgba(0,110,255,0.25)] mb-6"
          >
            JOIN WAITLIST
          </Button>
