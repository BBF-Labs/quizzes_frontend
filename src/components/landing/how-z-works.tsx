...
const mockLines = [
  {
    id: 1,
    status: "done",
    text: "PLAN CONFIRMED: 4 TOPICS, 24 QUESTIONS, ~14 MINS",
  },
                    ...
                    (line, i) =>
                      visibleLines.includes(i) && (
                        ...
                        >
                          ...
                          <span
                            className={`${line.status === "pending" ? "text-muted-foreground/50" : line.status === "progress" ? "text-primary font-bold" : "text-foreground font-medium"} tracking-wider uppercase`}
                          >
                            {line.text}
                          </span>
                        </motion.div>
              ...
              <div className="pt-6 border-t border-border/50">
                <div className="flex justify-between text-[10px] text-muted-foreground mb-3 font-bold uppercase tracking-widest">
                  ...
                  <motion.span
                    initial={{ opacity: 0 }}
                    animate={
                      visibleLines.length >= 4 ? { opacity: 1 } : { opacity: 0 }
                    }
