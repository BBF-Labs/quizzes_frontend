        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col items-start">
            <Link href="/" className="flex items-end space-x-2 mb-6 group">
              ...
              <span className="text-[10px] font-mono tracking-widest text-muted-foreground/60 uppercase leading-none mb-0.5">
                / BetaForge Labs
              </span>
            </Link>
            <p className="text-[13px] font-mono text-muted-foreground leading-relaxed max-w-50">
              Providing the infrastructure for disciplined students to excel in
          ...
          <div className="flex flex-col space-y-4">
            <h4 className="text-sm font-bold text-foreground tracking-widest uppercase mb-2">
              Platform
            </h4>
            <Link
              href="#"
            ...
            >
              <div className="flex w-full">
                <input
                  type="email"
                  placeholder={
                    status === "success" ? "THANK YOU" : "ENTER EMAIL"
                  }
                  value={email}
        ...
        <div className="container mx-auto px-4 max-w-6xl h-10 flex items-center overflow-hidden">
          <div className="flex flex-wrap items-center gap-6 text-[10px] font-mono text-muted-foreground overflow-x-auto no-scrollbar w-full">
            <div className="flex items-center gap-2">
              ...
              <span className="uppercase tracking-widest text-foreground whitespace-nowrap">
                System Status: Active
              </span>
            </div>
            <span className="uppercase tracking-widest whitespace-nowrap">
              <span className="text-foreground">GPT-4O</span> 0.00 MS
            </span>
            <span className="uppercase tracking-widest whitespace-nowrap">
              <span className="text-foreground">CURRICULUM SYNC</span> LIVE
            </span>
            <span className="uppercase tracking-widest whitespace-nowrap">
              <span className="text-foreground">DB LOAD</span> 1%
            </span>
