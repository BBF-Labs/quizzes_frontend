      ...
      <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm font-mono uppercase tracking-widest text-[10px] md:text-xs">
                Qz integrates directly with your institution&apos;s
                infrastructure.
              </p>
            </div>
        ...
        >
          <motion.div
            ...
            className="border border-border/50 bg-card p-8 md:p-10 hover:border-primary transition-colors relative group overflow-hidden rounded-lg"
          >
            ...
            <div className="w-10 h-10 border border-border/80 bg-background flex items-center justify-center mb-6 group-hover:border-primary/50 transition-colors rounded-lg">
            ...
            <p className="text-[15px] text-muted-foreground font-light leading-relaxed">
              Deploy across multiple sub-campuses seamlessly with unified but
              segregated central governance.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light leading-relaxed">
              Granular permission controls for administrators, faculty leaders,
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light leading-relaxed">
              Multi-stage content verification and structured sign-off workflows
              prior to institutional distribution.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[15px] text-muted-foreground font-light leading-relaxed">
              Cross-pollinate top materials automatically across related
              departments or aligned faculties.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <a
            href="#"
            className="flex items-center justify-center gap-2 mt-2 text-primary hover:text-primary/80 transition-colors font-bold group"
          >
            Get in touch{" "}
