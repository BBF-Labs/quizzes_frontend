    ...
    <section className="py-20 md:py-32 bg-secondary/10 border-b border-border/50 flex items-center">
      ...
      >
        <div className="mb-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
            <div>
              <motion.h2
                ...
                className="text-2xl md:text-3xl font-black tracking-[-0.04em] text-foreground mb-3 uppercase"
              >
                Meet Z
              </motion.h2>
              <motion.p
                variants={itemVariants}
                className="text-muted-foreground text-[10px] md:text-xs font-mono uppercase tracking-[0.15em] opacity-80"
              >
                A system that comprehends your curriculum, memorises your
                weaknesses, and tests you prior to advancement.
              </motion.p>
            </div>
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-wrap justify-start gap-4 font-mono text-[10px] sm:text-xs"
          >
