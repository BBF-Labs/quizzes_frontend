        ...
        {years.map((yearItem, idx) => (
          ...
          >
            <button
              ...
              className={`w-full group relative overflow-hidden flex flex-col items-center justify-center p-5 sm:p-8 border rounded-lg transition-all duration-300 min-h-28 sm:min-h-36 ${
                year === yearItem.value
