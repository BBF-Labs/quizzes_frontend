      ...
      >
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            required
            className="w-full min-w-0 rounded-lg font-mono bg-secondary/40 border-border focus-visible:ring-primary/50 h-11"
        ...
        <div className="space-y-1.5">
          ...
          <Textarea
            ...
            className="w-full min-w-0 rounded-lg font-mono bg-secondary/40 border-border focus-visible:ring-primary/50 min-h-25 resize-none"
        ...
        <Button
          ...
          className="w-full rounded-lg font-mono text-[11px] sm:text-xs tracking-[0.14em] sm:tracking-[0.2em] uppercase h-12 shadow-[0_0_20px_rgba(var(--primary),0.1)] hover:shadow-[0_0_30px_rgba(var(--primary),0.2)] transition-all"
        >
