      ...
      <div className="w-full space-y-12">
        ...
        <div className="space-y-4">
          <Button
            ...
            className="w-full rounded-lg font-mono text-xs tracking-[0.2em] uppercase h-14 bg-primary hover:bg-primary/90 shadow-[0_0_30px_rgba(var(--primary),0.15)] group"
          >
            {isSubmitting ? (
